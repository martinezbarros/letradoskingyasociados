...
export const metadata: Metadata = {
  ...
  description: 'Contacte a Letrados King y Asociados. Oficinas en Ciudad de Panamá. Especialistas en derecho público y protección de derechos fundamentales.',
  keywords: ["contacto abogados", "oficinas panamá", "consulta derecho administrativo", "defensa derechos humanos", "ubicación bufete", "asesoría legal"]
};
